...
public class C04_Iterator {
    ...
    bazı yapılar index desteklemez
    Bu durumda index olmadığından elementler yazdırmak istersek
     for each loop kullanabiriz ama elementelr arasında dolaşmak,
     belirli şartları update etmek istersek for each ile yapamayız.
     ...
     Bu sorunları çozmek için Java İteratör
     */
